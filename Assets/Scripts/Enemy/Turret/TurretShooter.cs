...
public class TurretShooter : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        var distance = Floats.Get(Floats.Item.turret_shell_speed) * Floats.Get(Floats.Item.turret_shell_existence_time);
    ...
    {
        cooldownRemain = Floats.Get(Floats.Item.turret_shooting_interval);
    }
}
...
public class Shooter
{
    static public Vector3 GetDirectionWithSpread(Vector3 origin, Vector3 target)
    {
        ...
        static float[] CalcRandomSpread(float[] pqr_vector)
        {
            ...
            // <calc spread>
            float h_max = Floats.Get(Floats.Item.turret_shell_h_spread);
            float v_max = Floats.Get(Floats.Item.turret_shell_v_spread);

...
namespace MyGame
{
    public class SV_Map : HostComponent
    {
        ...
        public override void Begin()
        {
            ...
            var map = Tool_MazeLikeMapGenerator.Generate(SV_Round.MazeRow, SV_Round.MazeCol);
            ...
            void SetFloorRoof(int row, int col)
            {
                ...
                var roof = GameObject.Instantiate(_roof, pos + new Vector3(0.0f, wall_height, 0.0f), Quaternion.identity);

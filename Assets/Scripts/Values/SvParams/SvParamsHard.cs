...
namespace MyGame
{
    public class SvParamsHard : MonoBehaviour
    {
        static public readonly Dictionary<SvParam, float> hardParamList = new Dictionary<SvParam, float>()
        {
            //
            // shop items
            ...
            { SvParam.shop_armor_cost_increase, 100 },
            ...
            { SvParam.shop_max_armor_cost_increase, 800 },

            { SvParam.shop_damage_rate_amount, 10 },
            { SvParam.shop_damage_rate_cost_default, 1000 },
            { SvParam.shop_damage_rate_cost_increase, 1300 },
            ...
            { SvParam.mine_destroy_reward, 600 },
            ...
            { SvParam.mine_hp_increase, 0.45f },
            { SvParam.turret_hp_increase, 0.45f },

            { SvParam.mine_damage, 150.0f },
            { SvParam.turret_damage, 20.0f },
            { SvParam.mine_damage_increase, 0.45f },
            { SvParam.turret_damage_increase, 0.45f },
            ...
            { SvParam.turret_tracking_speed_increase, 0.3f },

...
namespace MyGame
{
    public class SvParamsEazy : MonoBehaviour
    {
        static public readonly Dictionary<SvParam, float> eazyParamList = new Dictionary<SvParam, float>()
        {
            //
            // shop items
            ...
            { SvParam.shop_damage_rate_cost_increase, 1200 },

            { SvParam.shop_money_rate_amount, 20 },
            { SvParam.shop_money_rate_cost_default, 1000 },
            { SvParam.shop_money_rate_cost_increase, 1200 },
            ...
            { SvParam.field_armor_amount, 200 },
            ...
            { SvParam.additional_time_after_round, 200.0f },
            ...
            { SvParam.mine_damage, 110.0f },
            { SvParam.turret_damage, 15.0f },
            { SvParam.mine_damage_increase, 0.3f },
            { SvParam.turret_damage_increase, 0.3f },
            
            //
            // enemy's movement
            
            { SvParam.mine_default_roaming_speed, 4.5f },
            { SvParam.mine_roaming_speed_increase, 0.1f },

            { SvParam.mine_default_tracking_speed, 7.5f },
            { SvParam.mine_tracking_speed_increase, 0.1f },

            { SvParam.turret_default_roaming_speed, 3.0f },
            { SvParam.turret_roaming_speed_increase, 0.1f },

            { SvParam.turret_default_tracking_speed, 3.0f },
            { SvParam.turret_tracking_speed_increase, 0.1f },
            ...
            { SvParam.turret_shell_h_spread, 0.3f },
            { SvParam.turret_shell_v_spread, 0.1f },

            //
            // spawn

            { SvParam.n_enemies, 12 },

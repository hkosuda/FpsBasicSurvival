...
namespace MyGame
{
    public class BounceObject : MonoBehaviour
    {
        ...
        public float HalfSizeZ { get; set; }
        ...
        void Start()
        {
            ...
            var x = parent.transform.localScale.x;
            var z = parent.transform.localScale.z;
            ...
            var colliderX = Calcf.SafetyDiv(x + 0.2f, x, 0.0f);
            var colliderZ = Calcf.SafetyDiv(z + 0.2f, z, 0.0f);
            boxCollider.size = new Vector3(colliderX, 1.0f, colliderZ);
        }

...
namespace MyGame
{
    public class PM_PlaneVector : Controller
    {
        ...
        public override void FixedUpdate(float dt)
        {
            ...
            {
                PlaneVector = PmUtil.CalcVector(inputVector, currentVector, dt, false, PM_Crouching.IsCrouching);
                return;
            }
            ...
            {
                PlaneVector = PmUtil.CalcVector(inputVector, currentVector, dt, true, PM_Crouching.IsCrouching);
            }
